...
<header class="mainHeader">
    ...
    <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit.
        Rerum, minima fugit atque odit optio at iure iusto vel!
        Repudiandae magni nostrum neque asperiores esse nihil autem deserunt
        velit numquam voluptas.
    </p>
     <button>Start free trial</button>
    </article>
    <article>
        <img src="./img (3)/img/header.png" alt="">
    </article>
</header>
